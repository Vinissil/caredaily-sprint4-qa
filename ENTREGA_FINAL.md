# Checklist de Entrega Final - Care Daily (Sprint 4)

Este documento funciona como uma lista de verificação (checklist) para garantir que todas as exigências acadêmicas e técnicas da Sprint 4 da matéria **Testing, Compliance and Quality** tenham sido atendidas antes de submeter o trabalho ao portal do professor.
...
A parte de **Azure Boards** foi criada e preenchida com os testes manuais da Sprint 4.

Ainda faltam para fechamento total da entrega:

1. Subir os arquivos no GitHub público na branch `develop`;
2. Gravar o vídeo de execução dos testes automatizados;
3. Preencher o link do GitHub;
4. Preencher o link do vídeo de automação;
5. Conferir novamente os dados pessoais nas evidências antes do envio final.
